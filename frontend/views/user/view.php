...
<div class="user-view">
    ...
    <a href="/user/<?= $user->nickname ?>/followers" class="btn btn-primary"><?= $followersCount ?> followers</a>
    <a href="/user/<?= $user->nickname ?>/following" class="btn btn-primary"><?= $followingCount ?> following</a>
